...
class DisplayTube():
    ...
    def _buildTube(self):
        ...
        """self.mc.setBlocks(self.pos.x + 1, self.pos.y-1, self.pos.z,
                          self.pos.x + 1, self.pos.y-1 + self.height, self.pos.z,
                          block.GLASS.id)
        self.mc.setBlocks(self.pos.x - 1, self.pos.y-1, self.pos.z,
                          self.pos.x - 1, self.pos.y-1 + self.height, self.pos.z,
                          block.GLASS.id)
        self.mc.setBlocks(self.pos.x, self.pos.y-1, self.pos.z + 1,
                          self.pos.x, self.pos.y-1 + self.height, self.pos.z + 1,
                          block.GLASS.id)
        self.mc.setBlocks(self.pos.x, self.pos.y-1, self.pos.z - 1,
                          self.pos.x, self.pos.y-1 + self.height, self.pos.z - 1,
                          block.GLASS.id)
        ...
        if self.value != value:
            ...
            if newNumOfBlocks < self.numOfBlocks:
                ...
                self.mc.setBlocks(self.pos.x, self.pos.y + self.numOfBlocks, self.pos.z,
                                  self.pos.x + 2, self.pos.y + newNumOfBlocks + 1, self.pos.z,
                                  block.AIR.id)
                ...
                self.mc.setBlocks(self.pos.x, self.pos.y + self.numOfBlocks + 1, self.pos.z,
                                  self.pos.x + 2, self.pos.y + newNumOfBlocks, self.pos.z,
    ...
    def clear(self):
        ...
        self.mc.setBlocks(self.pos.x, self.pos.y, self.pos.z,
                          self.pos.x + 2, self.pos.y + self.height, self.pos.z,
                          block.AIR.id)
        self.mc.setBlocks(self.pos.x, self.pos.y, self.pos.z,
                          self.pos.x  + 2, self.pos.y + self.height, self.pos.z,
                          block.AIR.id)
        self.mc.setBlocks(self.pos.x, self.pos.y, self.pos.z + 1,
                          self.pos.x + 2, self.pos.y + self.height, self.pos.z + 1,
                          block.AIR.id)
        self.mc.setBlocks(self.pos.x, self.pos.y, self.pos.z - 1,
                          self.pos.x + 2, self.pos.y + self.height, self.pos.z - 1,
                          block.AIR.id)
